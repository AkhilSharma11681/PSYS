...
path = upload_frame(frame_rgb, INSTITUTION_ID, SESSION_ID, CAMERA_ID)

if path is None:
    print("UPLOAD FAILED — check .env has SUPABASE_URL/SUPABASE_SERVICE_ROLE_KEY, "
          "and that the 'capture-frames' bucket exists")
else:
    print(f"UPLOAD SUCCEEDED — path: {path}")
